...
$(document).ready(function () {
 ...
 $('#image-maps area').mouseout(function(){
   ...
   $('.snb_wrap .snb_tit').click(function(){
      $(this).parent().toggleClass('on')
   });
   }
    ...
    /*통합검색 js*/
    $('.sch_box .tit').click(function(){
        $(this).parent().toggleClass('on');
    });
    
    $('.rank_tab.weekly').click(function(){
       $(this).addClass('on'); 
       $('.rank.weekly').show();
       $('#dayPopKey').hide();
       $('.rank_tab.daily').removeClass('on')
    });
     $('.rank_tab.daily').click(function(){
       $(this).addClass('on'); 
       $('.rank.daily').show();
       $('#weekPopKey').hide();
       $('.rank_tab.weekly').removeClass('on') 
    });
...
$(window).resize(function() { if($(window).width() > 1025) { /*모바일*/
  $('.snb_wrap .snb_tit').click(function(){
      $(this).parent().toggleClass('on');
...
$(window).resize(function() { if($(window).width() > 390) { /*모바일*/
